            ...
            <div class="row clearfix">
                    ...
                    <table class="table table-bordered table-condensed">
                        ...
                        <#list generalDataTransactionPage.content as generalDataTransaction>
                            <tr>
                                ...
                                <td><a href="/demo03/sendMsgManager/detail?workid=${generalDataTransaction.workid}">详情</a></td>
                            </tr>
                        </#list>
                        </tbody>
                    </table>
                ...
                <div class="col-md-12 column">
                    <ul class="pagination pull-right">
                        ...
                        <#else>
                            <li><a href="/demo03/sendMsgManager/list?page=${currentPage - 1}&size=${size}">上一页</a></li>
                        </#if>
                        ...
                        <#list 1..generalDataTransactionPage.getTotalPages() as index>
                            ...
                            <#else>
                                <li><a href="/demo03/sendMsgManager/list?page=${index}&size=${size}">${index}</a></li>
                            </#if>
                        </#list>
                        ...
                        <#else>
                            <li><a href="/demo03/sendMsgManager/list?page=${currentPage + 1}&size=${size}">下一页</a></li>
                        </#if>
                    </ul>
                </div>
            </div>
